...
const Footer = () => {
    return (
        <footer className="px-4 divide-y dark:bg-[#304f47] dark:text-white mt-11">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                        <span className="self-center text-2xl font-semibold">If you have any question, Let us help you!</span>
                    </a>
                </div>
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    <div className="space-y-3">
                        <h3 className="tracking-wide uppercase dark:text-white">Home</h3>
                    ...
                    <div className="space-y-3">
                        <h3 className="tracking-wide uppercase dark:text-white">About us</h3>
                        <ul className="space-y-1">
                            <li>
                    ...
                    <div className="space-y-3">
                        <h3 className="uppercase dark:text-white">Our Teams</h3>
                        <ul className="space-y-1">
                            <li>
